...
<html>
    <head>
        ...
        <title>View All Borrow Records</title>
            ...
            <div id="contentwrapper">​
                <div id="contentcolumn">​
                    <div class="innertube">
                        ...
                        <div>
                            <ipage:page fullsize="<%=records.size()%>" limit="<%= limit%>" role="tech"  page="viewAllBrw"  />  
                        </div>
                        <form action="ReportController" class='s_bar_con'>
                            <input type="hidden" name="action" value="searchBorrow">
                        ...
                        <div id="usertable-container">
                            <report:show records="<%=records%>" equName="<%=equName%>" limit="<%=limit%>" page="viewAllBrw" dueTimeList="<%=dueTimeList%>" />  
                        </div>
                    </div>
                </div>​
            </div>​
